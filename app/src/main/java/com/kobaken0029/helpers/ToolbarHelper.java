...
public interface ToolbarHelper {
     ...
     * @param canPlayVoice    ボイスが再生できる場合true
     */
    void init(final BaseActivity activity, Toolbar toolbar, int titleId, boolean isShowBackArrow, boolean isShowMenu, boolean canPlayVoice);
